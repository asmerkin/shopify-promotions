...
function processActions(actions) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            lastCart = null;
            actions.forEach(function (next) { return __awaiter(_this, void 0, void 0, function () {
                var error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, CartApi_1["default"][next.action](next.payload)];
                        case 1:
                            lastCart = _a.sent();
                            return [3 /*break*/, 3];
                        case 2:
